...
import { addPlantsList } from '../../redux_actions/plantsListsActions';
import './scss/plantsList.scss';

const AddPlantsList = ({ addPlantsList }) => {
...
export default connect(mapStateToProps, { addPlantsList })(AddPlantsList);